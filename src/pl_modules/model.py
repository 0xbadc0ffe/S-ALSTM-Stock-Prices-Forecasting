...
class MyModel(pl.LightningModule):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.model = ALSTM.SALSTM4(input_dim=input_dim, seq_length=self.hparams.look_back, hidden_dim=hidden_dim, layer_dim=num_layers, output_dim=1, dropout_prob=dropout_prob, device="cuda:0")
